...
[CustomPropertyDrawer(typeof(RuleElement), true)]
public class RuleElementDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        int newIndex = EditorGUI.Popup(popupRect, "Rule Type", currentIndex, _subclassNames);
    ...
    private void Init()
    {
        _subclasses = AppDomain.CurrentDomain.GetAssemblies()
            ...
            .Where(t => typeof(RuleElement).IsAssignableFrom(t) && !t.IsAbstract)
            .ToArray();
